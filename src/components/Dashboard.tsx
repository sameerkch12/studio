...
const initialData: DeliveryEntry[] = [
  { id: '1', deliveryBoyName: 'Ramesh', date: new Date('2024-07-20'), delivered: 50, returned: 2, codCollected: 15000, rvp: 3 },
  { id: '2', deliveryBoyName: 'Suresh', date: new Date('2024-07-20'), delivered: 45, returned: 1, codCollected: 12500, rvp: 1 },
  { id: '3', deliveryBoyName: 'Ramesh', date: new Date('2024-07-21'), delivered: 55, returned: 0, codCollected: 18000, rvp: 5 },
  { id: '4', deliveryBoyName: 'Suresh', date: new Date('2024-07-21'), delivered: 62, returned: 3, codCollected: 22000, rvp: 0 },
];
